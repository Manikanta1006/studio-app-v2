...
import { Download, Paperclip, AtSign, Smile, ChevronRight } from 'lucide-react'
...
export default function ClinicalFeed({ collapsed, onToggle }: ClinicalFeedProps) {
  ...
  return (
    <>
      <aside
        className={`border-l border-outline-variant/30 flex flex-col z-30 overflow-hidden transition-all duration-300 flex-shrink-0 ${
          collapsed ? 'w-0' : 'w-[400px]'
        } bg-surface-container-low`}
      >
        {/* Patient Information Header */}
        <div className="p-6 bg-card border-b border-outline-variant/10">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h2 className="font-black text-on-surface tracking-tight text-lg">Sarah Johnson</h2>
              <p className="text-sm text-outline font-medium">Patient ID: #P-2024-08821</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div className="bg-surface-container p-3 rounded-lg">
              <p className="text-xs text-outline font-bold uppercase tracking-widest mb-1">Age</p>
              <p className="text-sm font-bold text-on-surface">34 years</p>
            </div>
            <div className="bg-surface-container p-3 rounded-lg">
              <p className="text-xs text-outline font-bold uppercase tracking-widest mb-1">Treatment</p>
              <p className="text-sm font-bold text-on-surface">Orthodontic</p>
            </div>
          </div>
        ...
        {/* Tabs */}
        <div className="flex bg-card border-b border-outline-variant/10">
        ...
        <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6 no-scrollbar">
          ...
          <div className="group">
            ...
            <div className="bg-card p-4 rounded-xl border border-outline-variant/20 shadow-sm group-hover:border-primary/30 transition-all cursor-pointer">
          ...
          <div className="group">
            ...
            <div className="bg-card p-4 rounded-xl border border-outline-variant/20 shadow-sm group-hover:border-primary/30 transition-all">
          ...
          <div className="group">
            <div className="flex items-start gap-4 mb-2">
              <div className="w-9 h-9 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-black text-sm border border-blue-200 flex-shrink-0">
                JC
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-center">
        ...
        {/* Post Note Section */}
        <div className="p-6 bg-card border-t border-outline-variant/30 shadow-[0_-4px_24px_rgba(0,0,0,0.06)]">
          <div className="relative">
            ...
            <div className="flex items-center justify-between mt-4">
              ...
              <button className="px-6 py-2.5 bg-primary text-primary-foreground text-[11px] font-black rounded-lg uppercase tracking-widest shadow-lg shadow-primary/25 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
      ...
      {!collapsed && (
        <button 
          onClick={onToggle}
          className="absolute right-0 top-1/2 -translate-y-1/2 bg-card border border-outline-variant/30 w-6 h-14 rounded-l-xl flex items-center justify-center text-outline hover:text-primary shadow-sm z-50 group transition-all flex-shrink-0"
        >
